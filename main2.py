            ...
            if available_transactions:
                ...
                if type == 0:
                    ...
                    if lift1_use == 0:
                        ...
                        min_fl = 1/max(cycletime)
                        max_fl = 1/min(cycletime)
                        if max_fl == min_fl:
                            norm_reward = 1
                        else:
                            norm_reward = ((1/cycle_time) - min_fl) / (max_fl - min_fl)
...
class Agent(object):
    def __init__(self, alpha, gamma, n_actions, epsilon, batch_size, input_dims,
                 epsilon_dec=0.99, epsilon_end=0.01, mem_size=1000000, fname='dqn_model3.h5'):
